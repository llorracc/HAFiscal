...
\begin{equation}\begin{gathered}\begin{aligned}
  \mathcal{W}^c =\frac{1}{N}\sum_{i=1}^{N} \sum_{t=0}^{\infty} \beta_S^t \cLvl_{it,\text{None},0,0} u'(\cLvl_{it,\text{None},0,0}) .
\end{aligned}\end{gathered}\end{equation}
...
\begin{equation}\begin{gathered}\begin{aligned}
  \mathcal{P}^c = \frac{1}{N}\sum_{i=1}^{N} \sum_{t=0}^{\infty} R^{-t} \cLvl_{it,\text{None},0,0} .
\end{aligned}\end{gathered}\end{equation}
