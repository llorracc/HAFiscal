...
In both models, the consumption multipliers over time horizons are similar, with the effect of the tax cut substantially smaller than the stimulus check or UI extension policies, despite the inclusion of supply-side effects in this HANK model.
However, the differences are somewhat muted because the aggregate demand effects in our partial equilibrium model do not continue beyond the recession, giving an extra boost to the stimulus check and extended UI policies in which spending occurs quickly.
