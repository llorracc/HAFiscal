...
\ifbool{upenn}{\date[\today]{University of Pennsylvania, 2024-11-06  \\ \medskip \medskip \medskip \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{econ-ark-logo-small.png}}}
...
\end{frame}
    ...
    \begin{frame}
      ...
      \item Idiosyncratic, stochastic income process $\yLvl_{i,t}$
      \item Estimated splurge factor $\varsigma$: $\cLvl_{sp,i,t} = \varsigma \yLvl_{i,t}$
        \pause
      ...
      \item Budget constraint, given existing market resources $m_{i,t}$ and income state, and a no-borrowing constraint: 
        \begin{equation}\begin{gathered}\begin{aligned}
          \mathbf{m}_{i,t+1} &= R \underbrace{(\mathbf{m}_{i,t} - \cLvl_{sp,i,t} - \cLvl_{opt,i,t})}_{\geq 0 \text{ (no-borrowing constraint)}} + \yLvl_{i,t+1}
        \end{aligned}\end{gathered}\end{equation}
